...
ALLOWED_HOSTS = ['librarymanagementsystem-lms.herokuapp.com', '127.0.0.1']
...
SECRET_KEY = 't$s72icrx@!hq0kos3^@3(to)ne^dy8$dctwoff58&gri-s)z)'
...
STATICFILES_DIRS=[os.path.join(BASE_DIR, 'librarymanagementsystem/static/')]
